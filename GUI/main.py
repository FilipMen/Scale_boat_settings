        ...
        if ui.serialPort.isOpen():
            ...
            if ui.serialPort.in_waiting:
                ...
                try:
                    ...
                    sensor = Complementary(gyr=np.array([[0,0,0]]),acc=acc_0,mag=mag_0,magnetic_ref=declination,frequency=1/0.05)
                    Qk1 = sensor.Q[0]
        ...
        if ui.serialPort.isOpen():
            ...
            if ui.serialPort.in_waiting:
                ...
                try:
                    ...
                    acc_quart = Quaternion(1,ax,ay,az)
                    base_acc = np.array(Quaternion.rotate_point(acc_data, Orientation),dtype=float)
                    ...
                    ui.MainWindow.accx1.setText(str(round(az, 3)))
